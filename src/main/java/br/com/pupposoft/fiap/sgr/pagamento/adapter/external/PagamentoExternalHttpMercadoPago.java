...
@Slf4j
@Component
public class PagamentoExternalHttpMercadoPago extends PagamentoExternoGateway {

	public PagamentoExternalHttpMercadoPago() {
		plataformaPagamentoExterna = PlataformaPagamentoExterna.MERCADO_PAGO;
	}
